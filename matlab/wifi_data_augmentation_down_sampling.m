...
% General Config
dataSource = [dataRoot, '/WIFI_Dataset/AugData/', 'ClearedDataset-20'];
dataTarget = [dataRoot, '/WIFI_Dataset/AugData/', 'ClearedDataset-20_ModelB_DS_S501-900'];
