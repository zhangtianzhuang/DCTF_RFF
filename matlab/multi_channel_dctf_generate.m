    ...
    for loop2 = 1:length(snrList)
        ...
        for i=3:fileNums
            ...
            for frame = 1:frameNums
                ...
                for pos = 1:length(DiffInterval)
                    fnDir = [ImageTargetPath, '/Diff_', num2str(DiffInterval(pos)), '/', FilePoint, '/', num2str(newFrameLabel)];
                ...
                % 
                Plot_Table_Size = 31;  % DCTF Size: 64 * 64 pixel
                Plot_Table_Max = 1.4;  % 
                ...
                for pos = 1:length(PlotTableSet)
                    ...
                    fnDir = [ImageTargetPath, '/Diff_', diff_name, '/', FilePoint, '/', num2str(newFrameLabel)];
